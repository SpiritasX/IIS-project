...
function AdminRelocationLogsPage() {
                            ...
                            <td colSpan={7} style={{ paddingBottom: 16, paddingTop: 10 }}>
                              ...
                              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px 24px', fontSize: 13 }}>
                                <label style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                                  ...
                                  <select className="variety-select" onChange={(e) => { setEditForm((f) => ({ ...f, siteId: e.target.value, storageSpaceId: '', sectorId: '' })); setSectors([]) }} style={inputSm} value={editForm.siteId}>
...
export default AdminRelocationLogsPage
